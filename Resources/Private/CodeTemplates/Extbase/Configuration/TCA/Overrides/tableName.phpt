...
<f:if condition="{extension.supportLocalization}">isset($GLOBALS['TCA']['{domainObject.databaseTableName}']['columns']['sys_language_uid']) && $GLOBALS['TCA']['{domainObject.databaseTableName}']['columns']['sys_language_uid']['exclude'] = 0;
isset($GLOBALS['TCA']['{domainObject.databaseTableName}']['columns']['l10n_parent']) && $GLOBALS['TCA']['{domainObject.databaseTableName}']['columns']['l10n_parent']['exclude'] = 0;</f:if>
